...
| Pending local commit | Record the development merge in the story delivery log before opening the follow-up PR.     | Keep the story record accurate after refreshing the branch.                                          |
