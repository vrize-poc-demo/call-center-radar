...
| Pending local commit | Tighten the global processing queue height and row density further.                         | Make the call detail content visible even when seven recent calls are present. |
