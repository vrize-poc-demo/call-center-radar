...
| Pending documentation commit | Record the left/right workspace layout commit in the story delivery log.                    | Keep the story record accurate after the follow-up UI fix.                                           |
